...
class _ReviewInputFields   {
  ...
  _ReviewInputFields({
    ...
    void addAll(covariant _ReviewInputFields other, { bool overwrite = true, }) {
...
class ReviewInput  {
  ...
  ReviewInput({
    ...
    bool get isValid => _missingRequiredFields.isEmpty;
...
class _ColorInputFields   {
  ...
  _ColorInputFields({
    ...
    /// its value is not overwritten, unless  `overwrite: true` is specified
    void addAll(covariant _ColorInputFields other, { bool overwrite = true, }) {
        assert(other != null, "Cannot add all from null into $this");
        if (overwrite != null && overwrite){
